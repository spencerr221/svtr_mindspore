...
#             predicts = predicts[-1]
#         print("before transpose:",predicts.shape)
#         predicts = predicts.transpose((1, 0, 2))
#         print("after transpose:",predicts.shape,type(batch),batch.shape)
#         N, B, _ = predicts.shape
#         preds_lengths = Tensor([N] * B, dtype=ms.int32)
#         labels = batch.astype("int64")
#         label_lengths = batch[:,2].astype('int32')
#         print("lllllllllllllllllllabels",labels.shape,predicts.shape,preds_lengths.shape,label_lengths.shape)
